...
namespace Infrastructure.DtoFetchers.TreeTypeDtoFetchers
{
    ...
    /// </summary>
    public class LocalityTypeDtoFetcher : BaseDtoFetcher<LocalityTypeDao, LocalityTypeDto>
    {
        static LocalityTypeDtoFetcher()
        {
            CreateMapForIndex();
            CreateMapForList();
            CreateMapForCard();
        ...
        private static void MapSpecificForList(IFetchDtoMap<LocalityTypeDao, LocalityTypeDto> map)
        {
        ...
        private static void MapSpecificForCard(IFetchDtoMap<LocalityTypeDao, LocalityTypeDto> map)
        {
            //map.Map(d => d.Id, e => e.C_Tree)
            //.Map(d => d.ParentTreeId, e => e.C_Parent_Tree);
        }

        public LocalityTypeDtoFetcher(IRepository repository)
            : base(repository)
        {
        }
    }
